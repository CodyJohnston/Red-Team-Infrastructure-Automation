...
resource "digitalocean_droplet" "phishing" {
  ...
  provisioner "remote-exec" {
    inline = [
        ...
        "mkdir -p /opt/gophish; cd /opt/gophish; wget https://github.com/gophish/gophish/releases/download/v0.11.0/gophish-v0.11.0-linux-64bit.zip -O gophish.zip && unzip gophish.zip; chmod +x gophish;",
